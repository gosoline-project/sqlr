...
func (r *repositoryCommon[K, E]) queryWithJoins(q sqlc.Querier, ctx context.Context, qb *QueryBuilderSelect, ttx *TTx) ([]E, error) {
	var err error
	...
	if rows, err = r.statementCache.Query(ctx, sqlcQB, ttx); err != nil {
